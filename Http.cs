...
namespace DTS4_AntennaSwitch
{
    sealed public class Http
    {
        public static Form1 form1;   // ke9ns mod  to allow form1 to pass back values to setup screen
        ...
        //=========================================================================================
        // ke9ns  ASYNC 
        public async Task<string> DTS4AAsync()
        {

                Debug.WriteLine("DTS4AASYNC=========");
   
                string content1 = " ";
              
                Debug.WriteLine("GOOD  data=========");
                    
                var url = new Uri("https://darrink1.ddns.net:219");
                ...
                Debug.WriteLine("GOOD  data1=========" + url);
        ...
        public void HttpServer1()
        {
            ...
            try
            {
                m_listener = new TcpListener(IPAddress.Any, form1.HTTP_PORT);
        ...
        // java:   imageArray[0] = applet.getImage(urlCodeBase,strImageArray[0]);
...
/*
        public void ImageRequest(TcpClient m_tcpClient)
        {
            ...
            if (form1.URLPRESENT == false) form1.URLPRESENT = true; // ke9ns: let the setup HTTP server know that someone is requesting an image


        //    byte[] imageArray = form1.getImage(); // ke9ns this gets either the Spectral Display or the entire Form1 widow and puts it into a jpeg byte array
...
*/
        ...
        private string getTimeRefresh()
        {
            ...
            return form1.HTTP_REFRESH.ToString();
...
/*
        private byte[] getImage()
        {
            ...
            bitmap = new Bitmap(form1.picDisplay.Width, form1.picDisplay.Height); // ke9ns set bitmap size to size of picDisplay since it gets resized with your screen
            form1.picDisplay.DrawToBitmap(bitmap, form1.picDisplay.ClientRectangle); // ke9ns grab picDisplay and convert to bitmap
...
*/
        ...
        /*     // ke9ns if you want to save image as a file and then read file
                private byte[] getImage()
                {
                    ...
                    bitmap = new Bitmap(form1.picDisplay.Width, form1.picDisplay.Height); // ke9ns set bitmap size to size of picDisplay since it gets resized with your screen
                    form1.picDisplay.DrawToBitmap(bitmap, form1.picDisplay.ClientRectangle); // ke9ns grab picDisplay and convert to bitmap
                    bitmap.Save(form1.AppDataPath + "picDisplay.jpg", ImageFormat.Jpeg); // ke9ns save image into database folder

                    FileInfo picDisplayFile = new FileInfo(form1.AppDataPath + "picDisplay.jpg");
                    FileStream picDisplayStream = new FileStream(form1.AppDataPath + "picDisplay.jpg", FileMode.Open, FileAccess.Read); // open file  stream 

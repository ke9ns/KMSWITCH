...
// common.cs
//=================================================================
// Form1 is a C# implementation of a Software Defined Radio.
...
namespace Form1
{
    public class Common
    {
        public static void ControlList(Control c, ref ArrayList a)
        {
            ...
            if ( c.GetType() == typeof(ComboBox) || c.GetType() == typeof(NumericUpDown) || c.GetType() == typeof(NumericUpDown) ||
...
/*
        public static void RestoreForm(Form form, string tablename, bool restore_size)
        {
            ...
            {
                if (c.GetType() == typeof(CheckBox))			// the control is a CheckBoxTS
                    checkbox_list.Add(c);
                else if (c.GetType() == typeof(ComboBox))		// the control is a ComboBox
                    combobox_list.Add(c);
                else if (c.GetType() == typeof(NumericUpDown))// the control is a NumericUpDown
                    numericupdown_list.Add(c);
                else if (c.GetType() == typeof(RadioButton))	// the control is a RadioButton
                    radiobutton_list.Add(c);
                else if (c.GetType() == typeof(TextBox))		// the control is a TextBox
                    textbox_list.Add(c);
                else if (c.GetType() == typeof(TrackBar))		// the control is a TrackBar (slider)
                    trackbar_list.Add(c);

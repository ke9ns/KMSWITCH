...
//================================================================= 
// Serial port support for KMSWITCH support of CAT and serial port control  
//=================================================================
...
namespace KMSWITCH
{
	public class SDRSerialPort
	{
		...
		public bool IsOpen
		{
			get
			{
                Debug.WriteLine("SDRserial isopen " + commPort.IsOpen);
		...
		public SDRSerialPort(int portidx)
		{
			...
			Debug.WriteLine("OPEN COM PORT NOW: " + "COM" + portidx.ToString() );
        ...
        */
        ...
        public SDRSerialPort(int portidx, int baudrate, Parity p, int databits, StopBits stop, Handshake handshake)
        {
            commPort = new SerialPort();
            commPort.Encoding = System.Text.Encoding.ASCII;
         //   commPort.RtsEnable = true; // hack for soft rock ptt 
		...
		//	commPort.DataBits = databits;
          //  commPort.Handshake = handshake;
			...
			Debug.WriteLine("COMMPORT: " + baudrate + ", " + p + ", " + stop + ", "+ databits + ", " + handshake);


		}


        // ke9ns: when in PowerSDR you transmit back a FA; request as FA000760000; (vfoa frequency),
		// But here we just transmit FA; from this program and PowerSDR should respond back with FA00076000 
        public uint put(string s) 
		{
            Debug.WriteLine("sdrserial PUT: " + s + ", " + commPort.IsOpen);
		...
		{
            Debug.WriteLine("sderserial receive data");
